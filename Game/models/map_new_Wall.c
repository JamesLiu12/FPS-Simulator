...
void ModelMap_new_Wall_Init(struct Mesh *map_new_wall) {
	...
	Vector3_Set(&map_new_wall->vertices[88], 57.484146, 4.8842e-2, -3.600599);
	Vector3_Set(&map_new_wall->vertices[89], 57.484146, 4.108842, -3.600599);
	Vector3_Set(&map_new_wall->vertices[90], 57.484146, 4.8842e-2, 3.399401);
	Vector3_Set(&map_new_wall->vertices[91], 57.484146, 4.108842, 3.399401);
	Vector3_Set(&map_new_wall->vertices[92], 58.14415, 4.8842e-2, -3.600599);
	Vector3_Set(&map_new_wall->vertices[93], 58.14415, 4.108842, -3.600599);
	Vector3_Set(&map_new_wall->vertices[94], 58.14415, 4.8842e-2, 3.399401);
	Vector3_Set(&map_new_wall->vertices[95], 58.14415, 4.108842, 3.399401);
	Vector3_Set(&map_new_wall->vertices[96], 20.0, 0.0, -15.1);
	Vector3_Set(&map_new_wall->vertices[97], 20.0, 2.5, -15.1);
	Vector3_Set(&map_new_wall->vertices[98], 20.0, 0.0, -14.9);
	Vector3_Set(&map_new_wall->vertices[99], 20.0, 2.5, -14.9);
	Vector3_Set(&map_new_wall->vertices[100], 60.0, 0.0, -15.1);
	Vector3_Set(&map_new_wall->vertices[101], 60.0, 2.5, -15.1);
	Vector3_Set(&map_new_wall->vertices[102], 60.0, 0.0, -14.9);
	Vector3_Set(&map_new_wall->vertices[103], 60.0, 2.5, -14.9);
	Vector3_Set(&map_new_wall->vertices[104], 10.0, 0.0, -10.1);
	Vector3_Set(&map_new_wall->vertices[105], 10.0, 2.5, -10.1);
	Vector3_Set(&map_new_wall->vertices[106], 10.0, 0.0, -9.9);
	Vector3_Set(&map_new_wall->vertices[107], 10.0, 2.5, -9.9);
	Vector3_Set(&map_new_wall->vertices[108], 15.0, 0.0, -10.1);
	Vector3_Set(&map_new_wall->vertices[109], 15.0, 2.5, -10.1);
	Vector3_Set(&map_new_wall->vertices[110], 15.0, 0.0, -9.9);
	Vector3_Set(&map_new_wall->vertices[111], 15.0, 2.5, -9.9);
	Vector3_Set(&map_new_wall->vertices[112], 15.1, 0.0, -20.0);
	Vector3_Set(&map_new_wall->vertices[113], 15.1, 2.5, -20.0);
	Vector3_Set(&map_new_wall->vertices[114], 14.900001, 0.0, -20.0);
	Vector3_Set(&map_new_wall->vertices[115], 14.900001, 2.5, -20.0);
	Vector3_Set(&map_new_wall->vertices[116], 15.099999, 0.0, 10.0);
	Vector3_Set(&map_new_wall->vertices[117], 15.099999, 2.5, 10.0);
	Vector3_Set(&map_new_wall->vertices[118], 14.9, 0.0, 10.0);
	Vector3_Set(&map_new_wall->vertices[119], 14.9, 2.5, 10.0);
	Vector3_Set(&map_new_wall->vertices[120], 20.1, 0.0, -15.0);
	Vector3_Set(&map_new_wall->vertices[121], 20.1, 2.5, -15.0);
	Vector3_Set(&map_new_wall->vertices[122], 19.9, 0.0, -15.0);
	Vector3_Set(&map_new_wall->vertices[123], 19.9, 2.5, -15.0);
	Vector3_Set(&map_new_wall->vertices[124], 20.1, 0.0, 5.0);
	Vector3_Set(&map_new_wall->vertices[125], 20.1, 2.5, 5.0);
	Vector3_Set(&map_new_wall->vertices[126], 19.9, 0.0, 5.0);
	Vector3_Set(&map_new_wall->vertices[127], 19.9, 2.5, 5.0);
	Vector3_Set(&map_new_wall->vertices[128], 50.100002, 0.0, -9.9);
	Vector3_Set(&map_new_wall->vertices[129], 50.100002, 2.5, -9.9);
	Vector3_Set(&map_new_wall->vertices[130], 49.900002, 0.0, -9.9);
	Vector3_Set(&map_new_wall->vertices[131], 49.900002, 2.5, -9.9);
	Vector3_Set(&map_new_wall->vertices[132], 50.099998, 0.0, 15.1);
	Vector3_Set(&map_new_wall->vertices[133], 50.099998, 2.5, 15.1);
	Vector3_Set(&map_new_wall->vertices[134], 49.899998, 0.0, 15.1);
	Vector3_Set(&map_new_wall->vertices[135], 49.899998, 2.5, 15.1);
	Vector3_Set(&map_new_wall->vertices[136], -11.477313, 0.0, 11.035891);
	Vector3_Set(&map_new_wall->vertices[137], -11.477313, 2.5, 11.035891);
	Vector3_Set(&map_new_wall->vertices[138], -11.335891, 0.0, 11.177313);
	Vector3_Set(&map_new_wall->vertices[139], -11.335891, 2.5, 11.177313);
	Vector3_Set(&map_new_wall->vertices[140], 9.73589, 0.0, -10.177313);
	Vector3_Set(&map_new_wall->vertices[141], 9.73589, 2.5, -10.177313);
	Vector3_Set(&map_new_wall->vertices[142], 9.877313, 0.0, -10.035891);
	Vector3_Set(&map_new_wall->vertices[143], 9.877313, 2.5, -10.035891);
	Vector3_Set(&map_new_wall->vertices[144], 25.1, 0.0, -10.0);
	Vector3_Set(&map_new_wall->vertices[145], 25.1, 2.5, -10.0);
	Vector3_Set(&map_new_wall->vertices[146], 24.9, 0.0, -10.0);
	Vector3_Set(&map_new_wall->vertices[147], 24.9, 2.5, -10.0);
	Vector3_Set(&map_new_wall->vertices[148], 25.1, 0.0, 5.0);
	Vector3_Set(&map_new_wall->vertices[149], 25.1, 2.5, 5.0);
	Vector3_Set(&map_new_wall->vertices[150], 24.9, 0.0, 5.0);
	Vector3_Set(&map_new_wall->vertices[151], 24.9, 2.5, 5.0);
	Vector3_Set(&map_new_wall->vertices[152], 15.0, 0.0, 9.9);
	Vector3_Set(&map_new_wall->vertices[153], 15.0, 2.5, 9.9);
	Vector3_Set(&map_new_wall->vertices[154], 15.0, 0.0, 10.1);
	Vector3_Set(&map_new_wall->vertices[155], 15.0, 2.5, 10.1);
	Vector3_Set(&map_new_wall->vertices[156], 45.0, 0.0, 9.9);
	Vector3_Set(&map_new_wall->vertices[157], 45.0, 2.5, 9.9);
	Vector3_Set(&map_new_wall->vertices[158], 45.0, 0.0, 10.1);
	Vector3_Set(&map_new_wall->vertices[159], 45.0, 2.5, 10.1);
	Vector3_Set(&map_new_wall->vertices[160], 45.100002, 0.0, -15.0);
	Vector3_Set(&map_new_wall->vertices[161], 45.100002, 2.5, -15.0);
	Vector3_Set(&map_new_wall->vertices[162], 44.900002, 0.0, -15.0);
	Vector3_Set(&map_new_wall->vertices[163], 44.900002, 2.5, -15.0);
	Vector3_Set(&map_new_wall->vertices[164], 45.099998, 0.0, 5.0);
	Vector3_Set(&map_new_wall->vertices[165], 45.099998, 2.5, 5.0);
	Vector3_Set(&map_new_wall->vertices[166], 44.899998, 0.0, 5.0);
	Vector3_Set(&map_new_wall->vertices[167], 44.899998, 2.5, 5.0);
	Vector3_Set(&map_new_wall->vertices[168], 25.0, 0.0, 4.9);
	Vector3_Set(&map_new_wall->vertices[169], 25.0, 2.5, 4.9);
	Vector3_Set(&map_new_wall->vertices[170], 25.0, 0.0, 5.1);
	Vector3_Set(&map_new_wall->vertices[171], 25.0, 2.5, 5.1);
	Vector3_Set(&map_new_wall->vertices[172], 45.0, 0.0, 4.9);
	Vector3_Set(&map_new_wall->vertices[173], 45.0, 2.5, 4.9);
	Vector3_Set(&map_new_wall->vertices[174], 45.0, 0.0, 5.1);
	Vector3_Set(&map_new_wall->vertices[175], 45.0, 2.5, 5.1);
	Vector3_Set(&map_new_wall->vertices[176], 25.0, 0.0, -10.1);
	Vector3_Set(&map_new_wall->vertices[177], 25.0, 2.5, -10.1);
	Vector3_Set(&map_new_wall->vertices[178], 25.0, 0.0, -9.9);
	Vector3_Set(&map_new_wall->vertices[179], 25.0, 2.5, -9.9);
	Vector3_Set(&map_new_wall->vertices[180], 40.0, 0.0, -10.1);
	Vector3_Set(&map_new_wall->vertices[181], 40.0, 2.5, -10.1);
	Vector3_Set(&map_new_wall->vertices[182], 40.0, 0.0, -9.9);
	Vector3_Set(&map_new_wall->vertices[183], 40.0, 2.5, -9.9);
	Vector3_Set(&map_new_wall->vertices[184], 40.099998, 0.0, -10.0);
	Vector3_Set(&map_new_wall->vertices[185], 40.099998, 2.5, -10.0);
	Vector3_Set(&map_new_wall->vertices[186], 39.900002, 0.0, -10.0);
	Vector3_Set(&map_new_wall->vertices[187], 39.900002, 2.5, -10.0);
	Vector3_Set(&map_new_wall->vertices[188], 40.099998, 0.0, 0.0);
	Vector3_Set(&map_new_wall->vertices[189], 40.099998, 2.5, 0.0);
	Vector3_Set(&map_new_wall->vertices[190], 39.900002, 0.0, 0.0);
	Vector3_Set(&map_new_wall->vertices[191], 39.900002, 2.5, 0.0);
	Vector3_Set(&map_new_wall->vertices[192], 30.0, 0.0, -0.1);
	Vector3_Set(&map_new_wall->vertices[193], 30.0, 2.5, -0.1);
	Vector3_Set(&map_new_wall->vertices[194], 30.0, 0.0, 0.1);
	Vector3_Set(&map_new_wall->vertices[195], 30.0, 2.5, 0.1);
	Vector3_Set(&map_new_wall->vertices[196], 40.0, 0.0, -0.1);
	Vector3_Set(&map_new_wall->vertices[197], 40.0, 2.5, -0.1);
	Vector3_Set(&map_new_wall->vertices[198], 40.0, 0.0, 0.1);
	Vector3_Set(&map_new_wall->vertices[199], 40.0, 2.5, 0.1);
	Vector3_Set(&map_new_wall->vertices[200], 30.1, 0.0, -5.0);
	Vector3_Set(&map_new_wall->vertices[201], 30.1, 2.5, -5.0);
	Vector3_Set(&map_new_wall->vertices[202], 29.9, 0.0, -5.0);
	Vector3_Set(&map_new_wall->vertices[203], 29.9, 2.5, -5.0);
	Vector3_Set(&map_new_wall->vertices[204], 30.1, 0.0, 0.0);
	Vector3_Set(&map_new_wall->vertices[205], 30.1, 2.5, 0.0);
	Vector3_Set(&map_new_wall->vertices[206], 29.9, 0.0, 0.0);
	Vector3_Set(&map_new_wall->vertices[207], 29.9, 2.5, 0.0);
	Vector3_Set(&map_new_wall->vertices[208], 30.0, 0.0, -5.1);
	Vector3_Set(&map_new_wall->vertices[209], 30.0, 2.5, -5.1);
	Vector3_Set(&map_new_wall->vertices[210], 30.0, 0.0, -4.9);
	Vector3_Set(&map_new_wall->vertices[211], 30.0, 2.5, -4.9);
	Vector3_Set(&map_new_wall->vertices[212], 35.0, 0.0, -5.1);
	Vector3_Set(&map_new_wall->vertices[213], 35.0, 2.5, -5.1);
	Vector3_Set(&map_new_wall->vertices[214], 35.0, 0.0, -4.9);
	Vector3_Set(&map_new_wall->vertices[215], 35.0, 2.5, -4.9);
	Vector3_Set(&map_new_wall->vertices[216], -9.3, 0.0, 14.9);
	Vector3_Set(&map_new_wall->vertices[217], -9.3, 2.5, 14.9);
	Vector3_Set(&map_new_wall->vertices[218], -9.3, 0.0, 15.1);
	Vector3_Set(&map_new_wall->vertices[219], -9.3, 2.5, 15.1);
	Vector3_Set(&map_new_wall->vertices[220], 6.7, 0.0, 14.9);
	Vector3_Set(&map_new_wall->vertices[221], 6.7, 2.5, 14.9);
	Vector3_Set(&map_new_wall->vertices[222], 6.7, 0.0, 15.1);
	Vector3_Set(&map_new_wall->vertices[223], 6.7, 2.5, 15.1);
	Vector3_Set(&map_new_wall->vertices[224], 6.9, 0.0, 11.9);
	Vector3_Set(&map_new_wall->vertices[225], 6.9, 2.5, 11.9);
	Vector3_Set(&map_new_wall->vertices[226], 6.9, 0.0, 12.1);
	Vector3_Set(&map_new_wall->vertices[227], 6.9, 2.5, 12.1);
	Vector3_Set(&map_new_wall->vertices[228], 9.9, 0.0, 11.9);
	Vector3_Set(&map_new_wall->vertices[229], 9.9, 2.5, 11.9);
	Vector3_Set(&map_new_wall->vertices[230], 9.9, 0.0, 12.1);
	Vector3_Set(&map_new_wall->vertices[231], 9.9, 2.5, 12.1);
	Vector3_Set(&map_new_wall->vertices[232], 6.9, 0.0, 12.0);
	Vector3_Set(&map_new_wall->vertices[233], 6.9, 2.5, 12.0);
	Vector3_Set(&map_new_wall->vertices[234], 6.7, 0.0, 12.0);
	Vector3_Set(&map_new_wall->vertices[235], 6.7, 2.5, 12.0);
	Vector3_Set(&map_new_wall->vertices[236], 6.9, 0.0, 15.0);
	Vector3_Set(&map_new_wall->vertices[237], 6.9, 2.5, 15.0);
	Vector3_Set(&map_new_wall->vertices[238], 6.7, 0.0, 15.0);
	Vector3_Set(&map_new_wall->vertices[239], 6.7, 2.5, 15.0);
	Vector3_Set(&map_new_wall->vertices[240], -1.663397, 0.0, 4.918911);
	Vector3_Set(&map_new_wall->vertices[241], -1.663397, 2.5, 4.918911);
	Vector3_Set(&map_new_wall->vertices[242], -1.836602, 0.0, 5.018911);
	Vector3_Set(&map_new_wall->vertices[243], -1.836602, 2.5, 5.018911);
	Vector3_Set(&map_new_wall->vertices[244], 1.836602, 0.0, 10.981089);
	Vector3_Set(&map_new_wall->vertices[245], 1.836602, 2.5, 10.981089);
	Vector3_Set(&map_new_wall->vertices[246], 1.663397, 0.0, 11.081089);
	Vector3_Set(&map_new_wall->vertices[247], 1.663397, 2.5, 11.081089);
