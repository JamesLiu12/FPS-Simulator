...
void ModelMap_new_Wall_Init(struct Mesh *map_new_wall) {
    ...
    Vector3_Set(&map_new_wall->vertices[128], 50.100002, 0.0, -9.874672);
    Vector3_Set(&map_new_wall->vertices[129], 50.100002, 2.5, -9.874672);
    Vector3_Set(&map_new_wall->vertices[130], 49.900002, 0.0, -9.874672);
    Vector3_Set(&map_new_wall->vertices[131], 49.900002, 2.5, -9.874672);
    Vector3_Set(&map_new_wall->vertices[132], 50.099998, 0.0, 15.125328);
    Vector3_Set(&map_new_wall->vertices[133], 50.099998, 2.5, 15.125328);
    Vector3_Set(&map_new_wall->vertices[134], 49.899998, 0.0, 15.125328);
    Vector3_Set(&map_new_wall->vertices[135], 49.899998, 2.5, 15.125328);
    Vector3_Set(&map_new_wall->vertices[136], -11.477313, 0.0, 11.05405);
    Vector3_Set(&map_new_wall->vertices[137], -11.477313, 2.5, 11.05405);
    Vector3_Set(&map_new_wall->vertices[138], -11.335891, 0.0, 11.195473);
    Vector3_Set(&map_new_wall->vertices[139], -11.335891, 2.5, 11.195473);
    Vector3_Set(&map_new_wall->vertices[140], 9.73589, 0.0, -10.159153);
    Vector3_Set(&map_new_wall->vertices[141], 9.73589, 2.5, -10.159153);
    Vector3_Set(&map_new_wall->vertices[142], 9.877313, 0.0, -10.017731);
    Vector3_Set(&map_new_wall->vertices[143], 9.877313, 2.5, -10.017731);
    ...
    Vector3_Set(&map_new_wall->vertices[160], 44.958744, 0.0, -15.0);
    Vector3_Set(&map_new_wall->vertices[161], 44.958744, 2.5, -15.0);
    Vector3_Set(&map_new_wall->vertices[162], 44.758743, 0.0, -15.0);
    Vector3_Set(&map_new_wall->vertices[163], 44.758743, 2.5, -15.0);
    Vector3_Set(&map_new_wall->vertices[164], 44.95874, 0.0, 5.0);
    Vector3_Set(&map_new_wall->vertices[165], 44.95874, 2.5, 5.0);
    Vector3_Set(&map_new_wall->vertices[166], 44.758739, 0.0, 5.0);
    Vector3_Set(&map_new_wall->vertices[167], 44.758739, 2.5, 5.0);
    Vector3_Set(&map_new_wall->vertices[168], 24.963116, 0.0, 4.9);
    Vector3_Set(&map_new_wall->vertices[169], 24.963116, 2.5, 4.9);
    Vector3_Set(&map_new_wall->vertices[170], 24.963116, 0.0, 5.1);
    Vector3_Set(&map_new_wall->vertices[171], 24.963116, 2.5, 5.1);
    Vector3_Set(&map_new_wall->vertices[172], 44.963116, 0.0, 4.9);
    Vector3_Set(&map_new_wall->vertices[173], 44.963116, 2.5, 4.9);
    Vector3_Set(&map_new_wall->vertices[174], 44.963116, 0.0, 5.1);
    Vector3_Set(&map_new_wall->vertices[175], 44.963116, 2.5, 5.1);
    ...
    Vector3_Set(&map_new_wall->vertices[184], 40.075665, 0.0, -10.0);
    Vector3_Set(&map_new_wall->vertices[185], 40.075665, 2.5, -10.0);
    Vector3_Set(&map_new_wall->vertices[186], 39.875668, 0.0, -10.0);
    Vector3_Set(&map_new_wall->vertices[187], 39.875668, 2.5, -10.0);
    Vector3_Set(&map_new_wall->vertices[188], 40.075665, 0.0, 0.0);
    Vector3_Set(&map_new_wall->vertices[189], 40.075665, 2.5, 0.0);
    Vector3_Set(&map_new_wall->vertices[190], 39.875668, 0.0, 0.0);
    Vector3_Set(&map_new_wall->vertices[191], 39.875668, 2.5, 0.0);
    ...
    Vector3_Set(&map_new_wall->vertices[216], -9.28956, 3.492e-2, 14.783874);
    Vector3_Set(&map_new_wall->vertices[217], -9.28956, 2.53492, 14.783874);
    Vector3_Set(&map_new_wall->vertices[218], -9.28956, 3.492e-2, 14.983874);
    Vector3_Set(&map_new_wall->vertices[219], -9.28956, 2.53492, 14.983874);
    Vector3_Set(&map_new_wall->vertices[220], 6.71044, 3.492e-2, 14.783874);
    Vector3_Set(&map_new_wall->vertices[221], 6.71044, 2.53492, 14.783874);
    Vector3_Set(&map_new_wall->vertices[222], 6.71044, 3.492e-2, 14.983874);
    Vector3_Set(&map_new_wall->vertices[223], 6.71044, 2.53492, 14.983874);
    Vector3_Set(&map_new_wall->vertices[224], 6.9, 0.0, 11.801003);
    Vector3_Set(&map_new_wall->vertices[225], 6.9, 2.5, 11.801003);
    Vector3_Set(&map_new_wall->vertices[226], 6.9, 0.0, 12.001003);
    Vector3_Set(&map_new_wall->vertices[227], 6.9, 2.5, 12.001003);
    Vector3_Set(&map_new_wall->vertices[228], 9.9, 0.0, 11.801003);
    Vector3_Set(&map_new_wall->vertices[229], 9.9, 2.5, 11.801003);
    Vector3_Set(&map_new_wall->vertices[230], 9.9, 0.0, 12.001003);
    Vector3_Set(&map_new_wall->vertices[231], 9.9, 2.5, 12.001003);
    Vector3_Set(&map_new_wall->vertices[232], 6.9, 0.0, 11.943678);
    Vector3_Set(&map_new_wall->vertices[233], 6.9, 2.5, 11.943678);
    Vector3_Set(&map_new_wall->vertices[234], 6.7, 0.0, 11.943678);
    Vector3_Set(&map_new_wall->vertices[235], 6.7, 2.5, 11.943678);
    Vector3_Set(&map_new_wall->vertices[236], 6.9, 0.0, 14.743677);
    Vector3_Set(&map_new_wall->vertices[237], 6.9, 2.5, 14.743677);
    Vector3_Set(&map_new_wall->vertices[238], 6.7, 0.0, 14.743677);
    Vector3_Set(&map_new_wall->vertices[239], 6.7, 2.5, 14.743677);
